...
import { utilBands } from '../theme/mfTokens';
...
// Now generated by mfTokens.utilBands(8) -- one source for this document and
// ExecutiveDashboardModal.jsx (same 8 hex stops as before, asserted by
// scripts/check-mf-tokens.mjs).
const GAUGE_BAND_COLORS = utilBands(8);
